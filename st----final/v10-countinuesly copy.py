...
Enhanced with Dual Buffer System and Word-Level Timestamp Tracking
...
class WhisperStreamingTranscriberWithSpecials:
    ...
    def _finalize_sentence(self, final_text=None):
        ...
        # Reset pattern detection state - preserve transcription history for continuous duplicate detection
    ...
    def start_streaming(self):
        ...
        try:
            ...
            print("Listening with Dual Buffer System + Word-Level Timestamps...")
